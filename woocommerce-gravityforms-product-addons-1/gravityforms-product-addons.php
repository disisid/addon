<?php
/*
  Plugin Name: WooCommerce - Gravity Forms Product Add-Ons - kingtheme.net
							...
							if (!empty($value) && !empty($arr_var)) {
								try {
									...
									if ($field['type'] == 'fileupload' && isset($lead[$field['id']])) {
										...
										$display_value = GFCommon::get_lead_field_display($field, $value, isset($lead["currency"]) ? $lead["currency"] : false, true);
